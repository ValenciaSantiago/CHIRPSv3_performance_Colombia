...
png(paste0(dir_plots ,"/", "Fig_performance_wind_correction.png"), units = "in",
    width = 12, height = 4., res = 600, pointsize = 11)

ggarrange(r_plot,B_plot,G_plot,kge_plot,
          ncol=4,nrow=1,labels = c("a", "b","c",'d'),
          label.x = c(0.18,-0.06,-0.05,-0.05,0.05),widths = c(10.5,8,8,8,8))
dev.off()


png(paste0(dir_plots ,"/SUPP_PLOTS/",
           "Fig_performance_wind_correction_regions.png"), units = "in",
    width = 12, height = 5., res = 600, pointsize = 11)
